...
// app/javascript/controllers/qa_card_controller.js
var qa_card_controller_default = class extends Controller {
  // [解説] ターゲットの定義
...
var quiz_controller_default = class extends Controller {
  ...
  async submitAnswer() {
    ...
    try {
      ...
      this.correctAnswerIdValue = result.correct_answer_id;
      this.disableChoices();
      this.applyFeedbackStyles();
...
var menu_controller_default = class extends Controller {
  ...
  toggleMenu() {
    if (window.innerWidth >= 1024) {
      this.menuTarget.classList.remove("hidden", "flex", "flex-col");
    } else {
...
var audio_player_controller_default = class extends Controller {
...
application.register("qa-card", qa_card_controller_default);
application.register("quiz", quiz_controller_default);
application.register("menu", menu_controller_default);
application.register("audio-player", audio_player_controller_default);
