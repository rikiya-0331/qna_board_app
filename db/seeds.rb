...
Rails.logger.debug '古いデータを削除しています...'
...
Rails.logger.debug 'カテゴリを作成しています...'
immigration = Category.create!(name: '入国審査')
customs = Category.create!(name: '税関')
Category.create!(name: '手荷物・乗り継ぎ')

Rails.logger.debug 'Q&Aデータと選択肢を作成しています...'
...
Rails.logger.debug 'シードデータの作成が完了しました。'
